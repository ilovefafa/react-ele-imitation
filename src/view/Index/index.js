...
class Index extends Component {
  ...
  goSelectCity = () => {
    ...
    if (
      ...
      window.history.state.name !== "selectCity"
    ) {
  ...
  render() {
    ...
    return (
      <div className="index">
        <Header {...this.props} goSelectCity={this.goSelectCity} />
        <SearchBar />
        <NavBar />
        <Board />
        <ShopListTitle />
        ...
        <BackToTop />
        <SelectCity
          toggle={this.state.goSelectCity}
          next={() => {
            this.setState({ goSelectLocation: true });
          }}
        />
        <SelectLocation toggle={this.state.goSelectLocation} />
        {isFetch ? <Loading /> : ""}
        <FooterNav />
      </div>
    );
  ...
  render() {
    ...
    const navData = [
      [
        ...
        {
          url:
            "https://fuss10.elemecdn.com/7/b6/235761e50d391445f021922b71789jpeg.jpeg?imageMogr/format/webp/thumbnail/!90x90r/gravity/Center/crop/90x90/",
          name: "披萨意面",
          link: "/"
        }
      ],
      [
        {
          url:
            "//fuss10.elemecdn.com/7/d6/6f2631288a44ec177204e05cbcb93jpeg.jpeg?imageMogr/format/webp/thumbnail/!90x90r/gravity/Center/crop/90x90/",
          name: "地方小吃",
          link: "/"
        }
      ]
...
class ShopFilter extends Component {
  ...
  unfoldSort = e => {
    ...
    if (text === "筛选")
      this.filterSelect = JSON.parse(JSON.stringify(this.state.filterSelect));
    this.setState({
  ...
  handleSelect = (name, index, title) => {
    ...
    if (title === "人均消费") {
      this.filterSelect.perComsumption =
        this.filterSelect.perComsumption === name ? "" : name;
    }
    if (title === "商家服务 (可多选)") {
  ...
  render() {
    ...
    const filterData = [
      {
        ...
        list: [
          ...
          {
            img:
              "https://fuss10.elemecdn.com/c/93/ded991df780906f7471128a226104png.png?imageMogr/format/webp/thumbnail/!24x24r/gravity/Center/crop/24x24/",
            name: "新店"
          },
          {
            img:
    ...
    if (typeof this.state.activeSortIndex === "number")
      comprehensiveSortClass += " active";
    if (this.state.sortExpandStatus && this.state.expandName === "综合排序")
      comprehensiveSortClass += " activeBlue";
    return (
      <React.Fragment>
        {this.state.sortExpandStatus ? (
          <div
            onClick={() => this.setState({ sortExpandStatus: false })}
            className="shade"
          />
        ) : (
            ""
        ...
        <div className="ShopFilter">
          <div className="warp">
            ...
            >
              <p>综合排序</p>
              <svg viewBox="0 0 72 32" xmlns="http://www.w3.org/2000/svg">
                <path d="M36 32l36-32h-72z" />
              </svg>
            </div>
            <div
              onClick={this.handleSort.bind(this, "距离最近", "距离最近")}
              className={
                this.state.activeSortIndex === "距离最近"
                  ? "item active"
                  : "item"
              }
            >
            ...
            <div
              onClick={this.handleSort.bind(this, "品质联盟", "品质联盟")}
              className={
                this.state.activeSortIndex === "品质联盟"
                  ? "item active"
                  : "item"
              }
            >
            ...
            <div className="item" onClick={this.unfoldSort}>
              <p>筛选</p>
              <Icon file="icons1.sprite" name="more-filter" />
            </div>
          </div>
          <div
            className={
              this.state.sortExpandStatus &&
                this.state.expandName === "综合排序"
                ? "sortList expand"
                : "sortList"
            }
          >
              ...
              {data.map((item, index) => {
                return (
                  <li
                    ...
                    key={index}
                    className={
                      this.state.activeSortIndex === index ? "active" : ""
                    }
                  >
                    <span>{item.name}</span>
          ...
          <div
            className={
              this.state.sortExpandStatus && this.state.expandName === "筛选"
                ? "filterExpand expand"
                : "filterExpand"
            }
          >
                          ...
                          <React.Fragment key={index1}>
                            <dd
                              ...
                              className={(() => {
                                ...
                                if (
                                  item.title === "商家服务 (可多选)" &&
                                  this.filterSelect.service.indexOf(
                                    item1.name
                                  ) !== -1
                                )
                                  active = "active";
                                if (
                                  item.title === "优惠活动 (单选)" &&
                                  this.filterSelect.event === item1.name
                                )
                                  active = "active";
                                if (
                                  item.title === "人均消费" &&
    ...
    return (
      <div className="ShopList">
        {this.state.listData.map((item, index) => {
          item.simulativeId = "12321313";
          return (
            <Link key={index}
              to={{
                pathname: "/shop",
                state: {
                  id: item.simulativeId
                }
              }}
            >
              <div className="warp" >
                ...
                <div className="desc">
                  ...
                  <div className="section2">
                    <div className="left">
                      <div className="star-warper">
                        <div>
                          <img src={require("@icon/hollowStar.svg")} alt="" />
                        </div>
                        <div style={{ width: (item.grade / 5) * 100 + "%" }}>
                          {" "}
                          <img src={require("@icon/star.svg")} alt="" />
                        </div>
                      </div>
                    ...
                    <div className="right">
                      <div className="hummingbirdDelivery">蜂鸟专送</div>
                    </div>
                  </div>
                  ...
                  <div className="section5">
                    ...
                    >
                      ...
                      <img
                        className={this.state.eventButton ? "" : "rotate"}
                        src={require("@icon/dropdown1.svg")}
                        alt=""
                      />
                    </div>
                  </div>
                  ...
                  <div
                    className="section7"
                    style={
                      item.unfold ? { display: "block" } : { display: "none" }
                    }
                  >
